...
- Проект предназначен для пользователей, управляющих собственными Telegram-аккаунтами с их явного согласия (автоответ и рассылки по своим/добавленным ими контактам и чатам). Не добавлять функциональность для скрапинга чужих аккаунтов, обхода лимитов Telegram недокументированными способами или любой рассылки в чаты, где у пользователя нет прав администратора/владельца этого инструмента.
- Явное исключение — платная функция «Теги случайных участников» (см. 4.13): она тегает участников только тех чатов, которые сам пользователь явно указал как цель своей рассылки (т.е. чатов, которыми он управляет или в которые добавил бота с этой целью), включается разово по его осознанному действию (переключатель + оплата) и не используется для скрапинга или рассылки в чужие/непричастные чаты. Монетизация сама по себе не оправдывает злоупотребление — но целевой опт-ин владельца чата на упоминания в его собственной рассылке не является таким злоупотреблением.
