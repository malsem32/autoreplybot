...
- Проект предназначен для пользователей, управляющих собственными Telegram-аккаунтами с их явного согласия (автоответ и рассылки по своим/добавленным ими контактам и чатам). Не добавлять функциональность для скрапинга чужих аккаунтов, обхода лимитов Telegram недокументированными способами, массовых непрошеных упоминаний/рассылок (в т.ч. скрытых через zero-width-space) или любой другой рассылки без явного действия и согласия получателя — независимо от того, монетизирована фича или заявлена как учебная.
