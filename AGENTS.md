...
### 4.12. Платная функция «Теги случайных участников» (Telegram Stars)

- `BroadcastCampaign.tag_random_users` можно включить только при наличии доступа — платно, через Telegram Stars (валюта `XTR`).
